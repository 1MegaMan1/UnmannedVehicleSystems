...
```
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image051.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image053.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image055.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image057.jpg)
```
Figure 4.1: Position of Sonar
```

![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image060.jpg)
```
Figure 4.2: Sonar Data Published to ROS
```

![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image062.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image064.jpg)
```
Figure 4.4: Position of LIDAR
```

![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image066.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image068.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/formulas1.JPG)

![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/formulas2.JPG)
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image070.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image076.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image077.gif)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image079.gif)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image081.jpg)
```
Figure 6.1: Simulation of Manhattan Path Planning
```

![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image083.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image084.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image087.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image089.jpg)
```
Figure 7.1: Accepted Images
```

![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image091.jpg)
```
...
![Alt Text](https://github.com/1MegaMan1/UnmannedVehicleSystems/blob/main/UVS_images/image093.jpg)
```
...
https://github.com/1MegaMan1/UnmannedVehicleSystems/
